...
# $status = New-JiraRemoteLinkStatus $statusIcon -Resolved
# $ro = New-JiraRemoteObject "https://ucsb-sist.atlassian.net/browse/POW-129" "POW-129" "A linked remote Jira issue" $objectIcon $status
