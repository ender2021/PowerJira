...
#https://developer.atlassian.com/cloud/jira/platform/rest/v2/#api-rest-api-2-permissionscheme-schemeId-permission-get
function Invoke-JiraGetPermissionSchemeGrants {
    [CmdletBinding()]
    param (
